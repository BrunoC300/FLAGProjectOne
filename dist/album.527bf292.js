...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../js/album.js":[function(require,module,exports) {
var albuns = [];
var albumId = 1;
...
var postAlbum = function postAlbum(nome, img) {
  //Procurar albuns
  albuns = JSON.parse(localStorage.getItem("albuns") || "[]"); // Modifying
...
var removeAlbum = function removeAlbum(id) {
  //localStorage.removeItem(//ID DO Album//);//
  albuns = JSON.parse(localStorage.getItem("albuns") || "[]");
  var novoAlbuns = albuns.filter(function (album) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../js/album.js"], null)
//# sourceMappingURL=/album.527bf292.js.map